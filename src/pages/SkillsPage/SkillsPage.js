...
import { html_icon, css_icon, js_icon, react_icon, redux_icon, sass_icon, ts_icon, git_icon, tailwind_icon } from "../../utils/images";
    ...
    <section className="skills-section sec" name="skills">
      <div className="skills-page">
        ...
        <div className="skills-icons-set">
          <div className="skills-icons-set-known flex-row-center" data-aos="fade-up" data-aos-duration="1000">
          ...
          <div className="skills-icons-set-familiar flex-row-center" data-aos="fade-right" data-aos-duration="1000">
